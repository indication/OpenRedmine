...
public class IssueListAdapterAll extends RedmineDaoAdapter<RedmineIssue, Long, DatabaseCacheHelper> {
	...
	public IssueListAdapterAll(DatabaseCacheHelper helper, Context context) {
	...
	public RedmineFilter getParameter() {
		...
		try {
			if(filter_id != null)
				...
				filter = mFilter.fetchByCurrent(connection_id);
